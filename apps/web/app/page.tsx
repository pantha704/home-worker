    ...
    <main>
      ...
      <section className="hero-shell">
        <div className="hero-copy">
          ...
          <p className="hero-lead">
            {preview
              ? "Privately preview text-layer PDFs in your browser. Scans, photos, OCR evidence, and full review require the local application."
          ...
          <ul className="hero-checks" aria-label="Homeworker benefits">
            ...
            <li><CheckIcon /> {hosted ? "Experimental free-tier hosted beta" : preview ? "Quick PDF preview—no OCR" : "Full local OCR service"}</li>
      ...
      <div className="page-shell">
        ...
        <section aria-labelledby="privacy-heading" className="trust-banner" id="privacy">
          ...
          <div>
            ...
            <p>{hosted ? "This invite-only hosted beta uses private account storage and bounded OCR, but live isolation, retention, and deletion drills remain release gates." : preview ? "Text-layer PDFs stay in this browser. For scanned PDFs, PNG, JPEG, OCR evidence, and all three personas, run the full local application." : "Files stay in your local Homeworker installation and use the FastAPI/Tesseract service on 127.0.0.1. Built-in personas are licensed styles—not copied handwriting or signatures."}</p>
          </div>
        </section>
      </div>
      ...
      <footer className="site-footer">
        <div className="page-shell footer-inner">
          <span>Homeworker · {hosted ? "Experimental hosted beta" : preview ? "Quick browser PDF preview" : "Full local application"}</span>
